          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Container(
                    margin: const EdgeInsets.only(left: 35, top: 15, right: 35),
                    child: Column(
                      children: [
                        Container(
                          width: 30,
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        margin: const EdgeInsets.only(bottom: 7),
                        child: Image.network(
                            'https://cdn-icons-png.flaticon.com/128/900/900782.png'),
                      ),
                      const Text(
                        "Cable TV\n& Internet",
                        style: TextStyle(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        margin: const EdgeInsets.only(bottom: 7),
                        child: Image.network(
                            'https://cdn-icons-png.flaticon.com/128/606/606797.png'),
                      ),
                      const Text(
                        "PDAM",
                        style: TextStyle(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        margin: const EdgeInsets.only(bottom: 7),
                        child: Image.network(
                            'https://cdn-icons-png.flaticon.com/128/3069/3069486.png'),
                      ),
                      const Text(
                        "Kartu Uang\n Elektronik",
                        style: TextStyle(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        margin: const EdgeInsets.only(bottom: 7),
                        child: Image.network(
                            'https://cdn-icons-png.flaticon.com/128/512/512142.png'),
                      ),
                      const Text(
                        "More",
                        style: TextStyle(
            ...
            Container(
              ...
              child: Row(
                children: [
                  Container(
                    margin: const EdgeInsets.only(left: 35, top: 5, right: 35),
                    child: Column(
                      children: [
                        Container(
                          width: 25,
